...
- [probabl-ai/skore: accelerate ML model dev with automated evals and reports](https://github.com/probabl-ai/skore/)
- [jlm429/pyperch: randomized opt networks with PyTorch used in Georgia Tech's ML class](https://github.com/jlm429/pyperch)
